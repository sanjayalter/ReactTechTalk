        ...
        {theme == "dark" ? (
          <aside className="flex h-screen w-64 flex-col overflow-y-auto border-r bg-black px-5 py-8">
            <a href="#">
              ...
              <p className=" text-white">React Tech Talk</p>
            </a>
              ...
              <nav className="-mx-3 space-y-6 ">
                <div className="space-y-3 ">
                  ...
                  >
                    ...
                    <span className="mx-2 text-sm font-medium">useState</span>
                  </a>
                  ...
                  >
                    <Newspaper className="h-5 w-5" aria-hidden="true" />
                    <span className="mx-2 text-sm font-medium">useContext</span>
                  </a>
                  <a
                    className="flex transform items-center rounded-lg px-3 py-2 text-gray-200 transition-colors duration-300 hover:bg-gray-100 hover:text-gray-700"
                    href="#"
          ...
          <aside className="flex h-screen w-64 flex-col overflow-y-auto border-r bg-white px-5 py-8">
            <a href="https://cginfinity.com/" target="_blank">
             
             <img src="https://cginfinity.com/wp-content/uploads/2022/04/logo-footer.svg" height={120} width={120} />
            </a>
            <div className="mt-6 flex flex-1 flex-col justify-between">
              <nav className="-mx-3 space-y-6 ">
                <div className="space-y-3 ">
